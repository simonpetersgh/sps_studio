...
export const metadata: Metadata = {
  title: "Services | SPS Studio",
  description: "Affordable web development packages starting at GHS 750. Custom software and mobile app development for Ghanaian startups and businesses.",
  openGraph: {
    title: "Software Development Services - SPS Studio",
    description: "Get a professional website or mobile app at affordable rates.",
  }
};
