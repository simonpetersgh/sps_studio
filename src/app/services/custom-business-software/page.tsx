...
import { Check, Facebook, Github, Instagram, Linkedin, LocateIcon, Mail, Phone, Twitter } from "lucide-react";
    ...
    return (
        <div className="flex flex-col min-h-dvh bg-background">
            ...
            <main className="flex-1">
                <section id="custom-software" className="py-20 px-4 sm:px-6 lg:px-8">
